...
if [[ "$1" == apache2* ]] || [ "$1" == php-fpm ]; then
  ...
  : "${ROUNDCUBEMAIL_PLUGINS:=archive,attachment_position,contextmenu,contextmenu_folder,message_highlight,infinite_scroll,html5_notifier,thunderbird_labels,remove_attachments,zipdownload}"
